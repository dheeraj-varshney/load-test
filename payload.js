const payload = {
  ...
  ContestsPostLockQuery: {
    query:"query ContestsPostLockQuery($site: String!, $matchId: Int!, $isJoined: Boolean = true, $isLoggedIn: Boolean = true, $cursor: String, $isFirstPage: Boolean = true, $isNetworkInContestNeeded: Boolean = false, $isInvitationInfoNeeded: Boolean = false) {\n  match(site: $site, id: $matchId) {\n    __typename\n    ... on Match @include(if: $isFirstPage) {\n      name\n      startTime\n      status\n    }\n    joinedContestPaginated(after: $cursor) {\n      __typename\n      edges {\n        __typename\n        ...ContestItem\n        myTeams {\n          __typename\n          name\n          id\n          rank\n          points\n          rankChange\n          winningAmount {\n            __typename\n            amount\n          }\n        }\n      }\n      pageInfo {\n        __typename\n        endCursor\n        hasNextPage\n      }\n    }\n  }\n}\n\nfragment ContestItem on Contest {\n  __typename\n  contestName\n  contestCategory\n  contestType\n  contestSize\n  currentSize\n  entryFee {\n    __typename\n    amount\n    symbol\n  }\n  id\n  inviteCode\n  isInfiniteEntry\n  isPartnerContest\n  isGuaranteed\n  isMultipleEntry\n  prizeDisplayText\n  numberOfWinners\n  winnerPercent\n  isMultipleEntry\n  invitationsInfo @include(if: $isInvitationInfoNeeded) {\n    __typename\n    channelName\n    channelUrl\n    invitationsCount\n    coverUrl\n  }\n  myNetworkInfo @include(if: $isNetworkInContestNeeded) {\n    __typename\n    ...NetworkInfoFragment\n  }\n  maxAllowedTeams\n  winnerBreakup(limit: 1) {\n    __typename\n    prizeDisplayText\n  }\n  prizeAmount {\n    __typename\n    amount\n    symbol\n  }\n  isFreeEntry\n  ... on Contest @include(if: $isLoggedIn) {\n    effectiveEntryFee {\n      __typename\n      amount\n    }\n  }\n  match {\n    __typename\n    id\n    status\n  }\n  tour {\n    __typename\n    id\n    name\n  }\n  site\n  ... on Contest @include(if: $isJoined) {\n    joinedTeamsCount\n    hasJoined @include(if: $isJoined)\n  }\n}\n\nfragment NetworkInfoFragment on MyNetworkInfo {\n  __typename\n  networkMemberTeams {\n    __typename\n    ...NetworkMemberTeam\n  }\n  totalCount\n}\n\nfragment NetworkMemberTeam on TeamsInNetwork {\n  __typename\n  name\n  profilePic {\n    __typename\n    src\n  }\n}\n",
    variables:{
      "site": "cricket",
      "matchId": 23971,
      "isLoggedIn": true,
  ...
  GetLiveStreamBanner: {
    ...
    "query": "query GetLiveStreamBanner($matchId: Int!) {  watchLiveRuleInfo(matchId: $matchId) {    __typename    fcMatchId    logoUrl    isUserEligible    progress {      __typename      remaining      total    }    backgroundColor  }}"
  },
  MyPromotionsQuery: {
